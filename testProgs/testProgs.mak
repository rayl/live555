...
ALL = testMP3Streamer$(EXE) testMP3Receiver$(EXE) testRelay$(EXE) testMPEG1or2Splitter$(EXE) testMPEG1or2VideoStreamer$(EXE) testMPEG1or2VideoReceiver$(EXE) testMPEG1or2AudioVideoStreamer$(EXE) testMPEG4VideoStreamer$(EXE) testWAVAudioStreamer$(EXE) vobStreamer$(EXE) openRTSP$(EXE) playSIP$(EXE) sapWatch$(EXE) 
all:	$(ALL)
