...
WINDOWSAUDIOINPUTDEVICE_LIB = libWindowsAudioInputDevice.$(LIB_SUFFIX)
ALL = $(WINDOWSAUDIOINPUTDEVICE_LIB) showAudioInputPorts$(EXE)
all::	$(ALL)
...
WINDOWSAUDIOINPUTDEVICE_LIB_OBJS = WindowsAudioInputDevice.$(OBJ)

WindowsAudioInputDevice.$(CPP):	WindowsAudioInputDevice.hh

$(WINDOWSAUDIOINPUTDEVICE_LIB): $(WINDOWSAUDIOINPUTDEVICE_LIB_OBJS) \
	$(PLATFORM_SPECIFIC_LIB_OBJS)
	$(LIBRARY_LINK)$@ $(LIBRARY_LINK_OPTS) \
	$(WINDOWSAUDIOINPUTDEVICE_LIB_OBJS)
...
LOCAL_LIBS = $(LIVEMEDIA_LIB) $(GROUPSOCK_LIB) \
	$(USAGE_ENVIRONMENT_LIB) $(BASIC_USAGE_ENVIRONMENT_LIB) \
	$(WINDOWSAUDIOINPUTDEVICE_LIB)
MULTIMEDIA_LIBS =       winmm.lib
LIBS = $(LOCAL_LIBS) $(LIBS_FOR_CONSOLE_APPLICATION) $(MULTIMEDIA_LIBS)

SHOW_AUDIO_INPUT_PORTS_OBJS = showAudioInputPorts.$(OBJ)

showAudioInputPorts$(EXE):	$(SHOW_AUDIO_INPUT_PORTS_OBJS) $(LOCAL_LIBS)
	$(LINK)$@ $(CONSOLE_LINK_OPTS) $(SHOW_AUDIO_INPUT_PORTS_OBJS) $(LIBS)
